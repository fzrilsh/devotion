            ...
            <section className="col-span-1 lg:col-span-2 relative flex min-h-full w-full items-center justify-center overflow-hidden px-6 py-10">
                ...
                <div className="relative w-full max-w-xl">
                    <div className="mb-8 flex items-center flex-col gap-3">
                        <p className="mb-2 text-sm font-semibold uppercase tracking-wider text-industrial-orange-500">Verifikasi Email</p>
                        ...
                        <div className="mt-4 inline-flex items-center gap-2 rounded-lg bg-slate-50 px-3 py-2">
                            <LuMail className="h-4 w-4 text-industrial-orange-500" />
                            <p className="mt-2 font-semibold text-slate-800">contoh@email.com</p>
                        </div>
                    </div>
                    ...
                    <div className="mt-6 text-center">
                        {countdown > 0 ? (
                            ...
                            <button type="button" className="inline-flex cursor-pointer items-center gap-2 text-sm font-semibold text-industrial-orange-500 hover:text-industrial-orange-600">
