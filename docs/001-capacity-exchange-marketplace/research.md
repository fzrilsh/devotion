...
Bentuk respons sudah diverifikasi 2026-08-22. Respons dibungkus objek data dengan field code dan name; provinsi berkode dua digit, kabupaten/kota berkode bertitik seperti 32.73. Seeder wajib membuang titiknya menjadi 3273, karena kota_kode_format, kota_milik_provinsinya, dan pattern openapi.yaml semuanya mengasumsikan empat digit tanpa pemisah. Rincian dan kueri verifikasinya ada di docs/master-data/README.md.
